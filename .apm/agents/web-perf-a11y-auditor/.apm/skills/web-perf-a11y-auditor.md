...
description: Orchestrator skill for the web-perf-a11y-auditor agent. Use when the user asks to audit a website for performance or accessibility issues, investigate Core Web Vitals (LCP, CLS, INP, FCP, TTFB), check WCAG compliance, debug slow page loads, analyse network requests, inspect rendering performance, or evaluate accessibility of a page. Triggers on phrases like "audit my site", "check accessibility", "why is LCP high", "run a Lighthouse audit", "WCAG compliance", "performance issues", "check contrast", or any request to evaluate a URL for speed or a11y problems.
---
